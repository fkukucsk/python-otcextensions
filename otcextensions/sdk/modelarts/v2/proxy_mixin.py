...
from otcextensions.sdk.modelarts.v2 \
    import dataset_import_task as _dataset_import_task
from otcextensions.sdk.modelarts.v2 \
    import dataset_export_task as _dataset_export_task
from otcextensions.sdk.modelarts.v2 import dataset_synchronization_task as _dataset_synchronization_task
from otcextensions.sdk.modelarts.v2 import dataset_version as _dataset_version
from otcextensions.sdk.modelarts.v2 import dataset as _dataset
from otcextensions.sdk.modelarts.v2 import label as _label
# from otcextensions.sdk.modelarts.v2 import sample as _sample
from otcextensions.sdk.modelarts.v2 import dataset_sample as _dataset_sample
...
class V2ProxyMixin:
    ...
    def datasets(self):
        ...
        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v2\
                    .dataset.Datasets`) instances
        """
        return self.v2._list(_dataset.Dataset)

    def create_dataset(self, **attrs):
        """Create a dataset from attributes

        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~otcextensions.sdk.modelarts.v2.datasets.Datasets`,
            comprised of the properties on the Datasets class.
        :returns: The results of dataset creation
        :rtype: :class:`~otcextensions.sdk.modelarts.v2.datasets.Datasets`
        """
        return self.v2._create(
            _dataset.Dataset, prepend_key=False, **attrs
        )
    ...
    def delete_dataset(self, dataset, ignore_missing=False):
        ...
        """
        return self.v2._delete(_dataset.Dataset, dataset,
    ...
    def show_dataset(self, dataset):
        ...
        :returns: instance of
            :class:`~otcextensions.sdk.modelarts.v2.datasets.Datasets`
        """
        return self.v2._get(_dataset.Dataset, dataset)
    ...
    def find_dataset(self, name_or_id, ignore_missing=False):
        ...
        """
        return self._find(_dataset.Dataset, name_or_id,
                          ignore_missing=ignore_missing)
    ...
    def modify_dataset(self, dataset_id, **attrs):
        ...
        :returns: instance of
            :class:`~otcextensions.sdk.modelarts.v2.datasets.Datasets`
        """
        return self.v2._update(_dataset.Dataset, dataset_id, **attrs)
    ...
    def labels(self, **attrs):
        ...
        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v2.label.Label`) instances
        """
        return self.v2._list(_label.Label, **attrs)

    def label_stats(self, **attrs):
        """List all Labels.

        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v2.label.LabelStatistic`)
            instances
        """
        return self.v2._list(_label.LabelStatistic, **attrs)

    def create_label(self, **attrs):
        """Create a cluster from attributes

        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~otcextensions.sdk.modelarts.v2.labels.Labels`,
            comprised of the properties on the Labels class.
        :returns: The results of label creation
        :rtype: :class:`~otcextensions.sdk.modelarts.v2.label.Label`
        """
        return self.v2._create(
            _label.Label, prepend_key=False, **attrs
        )
    ...
    def delete_label(self, label, ignore_missing=False):
        ...
        """
        return self.v2._delete(
            _label.Label, label, ignore_missing=ignore_missing,
        )
    ...
    def show_label(self, label):
        ...
        :param label: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v2.label.Label`
    ...
    def dataset_version(self, **attrs):
        ...
        """
        return self.v2._list(_dataset_version.DatasetVersion, **attrs)
    ...
    def show_dataset_version(self, version_id, **attrs):
        """Get the dataset version by version id
         ...
         :returns: instance of
             :class:`~otcextensions.sdk.modelarts.v2.dataset_version.DatasetVersion`
         """
        return self.v2._get(
            _dataset_version.DatasetVersion, version_id, **attrs
        )
    ...
    def list_dataset_synchronization_task(self, **attrs):
        ...
        """
        return self.v2._list(_dataset_synchronization_task.DatasetSynchronizationTask, **attrs)
    ...
    def synchronize_dataset(self, **attrs):
        ...
        """
        return self.v2._create(
            _dataset_synchronization_task.SynchronizeDataset, prepend_key=False, **attrs
        )
    ...
    def show_dataset_export_task(self, task_id, **attrs):
        """Get the dataset export task by dataset id
          ...
          :returns: instance of :class:`~otcextensions.sdk.modelarts.v2.\
    ...
    #          :class:`~otcextensions.sdk.modelarts.v2.samples.Samples`
    ...
    def dataset_export_tasks(self, **attrs):
        ...
        """
        return self.v2._list(_dataset_export_task.DatasetExportTask, **attrs)
    ...
    def dataset_import_tasks(self, **attrs):
        ...
        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v2.\
                    dataset_import_task.DatasetImportTask`) instancesopenstack ma dataset sync list --dataset_id ZJRIFSTuToltIoZ8qLK --debug
        """
        return self.v2._list(_dataset_import_task.DatasetImportTask, **attrs)
    ...
    def dataset_samples(self, dataset_id, **params):
        ...
        """
        return self.v2._list(_dataset_sample.DatasetSample,
    ...
    def add_dataset_samples(self, dataset_id, **attrs):
        ...
        :param dict attrs: Keyword arguments which will be used to create
            ...
            a :class:`~otcextensions.sdk.modelarts.v2.\
                    dataset_sample.DatasetSample`,

        :returns: The result after uploading the dataset samples.

        :rtype: :class:`~otcextensions.sdk.modelarts.v2.\
                dataset_sample.DatasetSample`
        """

        return self.v2._create(_dataset_sample.DatasetSample,
                               dataset_id=dataset_id, **attrs)

    def delete_dataset_samples(self, dataset_id, *samples,
                               delete_source=False):
        """Delete an instance
        ...
        return obj.delete_samples(self, *samples, delete_source)
    ...
    def get_dataset_sample(self, dataset_id, sample_id):
        ...
        :param dataset_id: Dataset ID.
        :param sample_id: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v2.dataset_sample.DatasetSample`
        :returns: instance of
            :class:`~otcextensions.sdk.modelarts.v2.dataset_sample.DatasetSample`
        """
        return self.v2._get(_dataset_sample.DatasetSample,
                            sample_id, dataset_id=dataset_id)
