...
class Config(resource.Resource):
    ...
    #: Resource flavor. This parameter is returned when infer_type is set to real-time.
...
class ServiceMonitoringInformation(resource.Resource):
    ...
    #: Properties
    #: Service name. The value can contain 1 to 64 visible characters, including Chinese characters.
    ...
    monitors = resource.Body('monitors', type=list, list_type=dict)
