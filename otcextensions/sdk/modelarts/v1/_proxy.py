...
from otcextensions.sdk.modelarts.v2 import _proxy as proxy_v2
from otcextensions.sdk.modelarts.v1 import model as _model
from otcextensions.sdk.modelarts.v1 import clusters as _clusters
from otcextensions.sdk.modelarts.v1 import service as _service
from otcextensions.sdk.modelarts.v1 import service_monitor_info as _service_monitor_info
from otcextensions.sdk.modelarts.v1 import service_event_log as _service_event_log
from otcextensions.sdk.modelarts.v1 import service_update_log as _service_update_log
from otcextensions.sdk.modelarts.v1 import service_deployment_specification as _service_deployment_specification
from otcextensions.sdk.modelarts.v1 import trainingjob as _trainingjob
from otcextensions.sdk.modelarts.v1 import trainingjob_version as \
    _trainingjob_version
from otcextensions.sdk.modelarts.v1 import trainingjob_config as _trainingjob_config
from otcextensions.sdk.modelarts.v1 import devenv as _devenv
from otcextensions.sdk.modelarts.v1 import visualization_job as \
    _visualization_job
from otcextensions.sdk.modelarts.v2 import proxy_mixin


class Proxy(proxy.Proxy, proxy_mixin.V2ProxyMixin):
    skip_discovery = True
    ...
    def __init__(self, session, *args, **kwargs):
        ...
        kwargs.update(service_type='modelartsv2')
        self.v2 = proxy_v2.Proxy(session, *args, **kwargs)

    # ======== Models ========
    def models(self, **attrs):
        """List all Models.

        :returns: a generator of
            :class:`~otcextensions.sdk.modelarts.v1.models.Models`) instances
        """
        return self._list(_model.Model)

    def create_model(self, **params):
        """Create a model from attributes

        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~otcextensions.sdk.modelarts.v1.models.Models`,
            comprised of the properties on the Models class.
        :returns: The results of model creation
        :rtype: :class:`~otcextensions.modelarts.v1.models.Models`
        """
        return self._create(
            _model.Model, prepend_key=False, **params
        )

    def delete_model(self, model, ignore_missing=True):
        """Delete a model
        ...
        """
        return self._delete(
            _model.Model, model, ignore_missing=True,
        )
    ...
    def get_model(self, model):
        ...
        :param model: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v1.models.Models`
    ...
    def find_model(self, name_or_id, ignore_missing=False):
        ...
        :returns:
            One :class:`~otcextensions.sdk.modelarts.v1.model.Model`
            or ``None``
        """
    ...
    def services(self, **attrs):
        ...
        :returns: a generator of
            :class:`~otcextensions.sdk.modelarts.v1.services.Services`
            instances
        """
    ...
    def create_service(self, **attrs):
        ...
        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~otcextensions.sdk.modelarts.v1.service.Service`,
            comprised of the properties on the Service class.
        :returns: The result of service creation.
        :rtype: :class:`~otcextensions.sdk.modelarts.v1.services.Services`
        """
        return self._create(
            _service.Service, prepend_key=False, **attrs
        )

    def delete_service(self, service, ignore_missing=False):
        """Delete a service
        :param service: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v1.service.Service`
        :param bool ignore_missing: When set to ``False``
            :class:`~openstack.exceptions.ResourceNotFound` will be raised when
        ...
        :returns: ``None``
        """
        return self._delete(_service.Service, service,
                            ignore_missing=ignore_missing)
    ...
    def find_service(self, name_or_id, ignore_missing=False):
        ...
        :returns:
            One :class:`~otcextensions.sdk.modelarts.v1.service.Service`
            or ``None``
        """
    ...
    def devenv_instances(self, **params):
        """List all DevEnviron Instances.

        :returns: a generator of
            :class:`~otcextensions.sdk.modelarts.v1.devenv.Devenv` instances.
        """
        if params.get('limit'):
    ...
    def create_devenv_instance(self, **attrs):
        """Create a devenv from attributes

        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~otcextensions.sdk.modelarts.v1.devenv.Devenv`,
            comprised of the properties on the Devenv class.
        :returns: The results of demanager creation
        :rtype: :class:`~otcextensions.sdk.modelarts.v1.devenv.Devenv`
        """
        return self._create(
    ...
    def delete_devenv_instance(self, instance, ignore_missing=False):
        ...
        :param instance: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v1.devenv.Devenv`
        :param bool ignore_missing: When set to ``False``
            :class:`~openstack.exceptions.ResourceNotFound` will be raised when
            the group does not exist.
            When set to ``True``, no exception will be set when attempting to
    ...
    def find_devenv_instance(self, name_or_id, ignore_missing=False):
        ...
        :returns:
            One :class:`~otcextensions.sdk.modelarts.v1.devenv.Devenv`
            or ``None``
        """
    ...
    def trainingjobs(self, **params):
        ...
        :returns: a generator of
            :class:`~otcextensions.sdk.modelarts.v1.trainjob.Trainjob`
            instances
        """
    ...
    def trainingjob_versions(self, job_id, **attrs):
        ...
        :returns: a generator of
            :class:`~otcextensions.sdk.modelarts.v1.trainjob_version.\
                    TrainjobVersion` instances
        """
        return self._list(_trainingjob_version.TrainingJobVersion,
                          jobId=job_id, **attrs)
    ...
    def create_training_job(self, **attrs):
        ...
        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~otcextensions.sdk.modelarts.v1.trainjob.Trainjob`,
    ...
    def delete_trainingjob(self, job_id):
        ...
        """
        return self._delete(
            _trainingjob.TrainingJob, job_id
        )
    ...
    def find_trainingjob(self, name_or_id, ignore_missing=False):
        ...
        :returns: One :class:
          `~otcextensions.sdk.modelarts.v1.trainjob.Trainjob` or ``None``
        """
        return self._find(_trainingjob.TrainingJob, name_or_id,
                          ignore_missing=ignore_missing)
    ...
    def show_trainingjob_version(self, version_id, **attrs):
        ...
        :param version_id: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v1.trainjob_version.TrainjobVersion`
    ...
    def trainingjob_configuration(self, **attrs):
        ...
        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v1.trainjob_configs.TrainjobConfigs`) instances
        """
    ...
    def create_trainingjob_config(self, **attrs):
        ...
        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~otcextensions.sdk.modelarts.v1.trainjob_configs.TrainjobConfigs`,
            comprised of the properties on the Training Job Configuration class.
        :returns: The results of Training Job Configuration creation
        :rtype: :class:`~otcextensions.sdk.modelarts.v1.trainjob_configs.TrainjobConfigs`
        """
        return self._create(
    ...
    def delete_trainingjob_config(self, config_name):
        ...
        """
        return self._delete(
            _trainingjob_config.TrainingjobConfig, config_name, ignore_missing=True,
        )
    ...
    def show_trainingjob_conf(self, trainingjob_config):
        ...
        :param trainjob_config: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v1.trainjob_config.TrainjobConfigs`
    ...
    def visualization_jobs(self):
        ...
        :returns: a generator of :class:
          `~otcextensions.sdk.modelarts.v1.visualization_job.VisualizationJob`
          instances
        """
    ...
    def create_visualizationjob(self, **attrs):
        ...
        :param dict attrs: Keyword arguments which will be used to create a
            :class:`~otcextensions.sdk.modelarts.v1.visualization_job.\
    ...
    def show_visualizationjob(self, visualization_job):
        ...
        :param visualization_job: key id or an instance of
            :class:`~otcextensions.sdk.modelarts.v1.visualization_jobs.VisualizationJobs`
    ...
    def stop_visualizationjob(self, instance):
        """Stop a DevEnviron Instance
        ...
        :returns: instance of
            :class:`~otcextensions.sdk.modelarts.v1.devenv.Devenv`
        """
        visjob = self._get_resource( _visualization_job.VisualizationJob, visualization_job)
    ...
    def service_monitoring_info(self, **attrs):
        ...
        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v1.service_monitoring_info.ServiceMonitoringInfo`) instances
        """
        return self._list(_service_monitor_info.ServiceMonitoringInformation, **attrs)

    def service_event_logs(self, **attrs):
        """List all service event logs.

        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v1.service_event_logs.ServiceEventLogs`) instances
        """
    ...
    def service_update_logs(self, **attrs):
        ...
        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v1.service_update_logs.ServiceUpdateLogs`) instances
        """
    ...
    def service_deploy_specs(self):
        ...
        :returns: a generator of
            (:class:`~otcextensions.sdk.modelarts.v1.clusters.ServiceDeploySpecs`) instances
        """
        return self._list(_service_deploy_spec.ServiceDeploymentSpecification)
