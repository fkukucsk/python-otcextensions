...
class DeleteVisualizationJob(command.Command):
    ...
    def get_parser(self, prog_name):
        parser = super(DeleteVisJob, self).get_parser(prog_name)
        parser.add_argument(
            '--job_id',
            metavar='<job_id>',
...
class CreateVisualizationJob(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar='<job_name>',
            required=True,
            help=_('Name of a visualization job. The value is a string of '
        ...
        parser.add_argument(
            ...
            metavar='<job_desc>',
            required=False,
            help=_('Description of a visualization job. The value is a '
...
class ModifyVisualizationJobDescription(command.ShowOne):
    _description = _('Modify Visualization Job Description')

    def get_parser(self, prog_name):
        parser = super(ModifyVisJobDesc, self).get_parser(prog_name)
...
class StopVisualizationJob(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        parser = super(StopVisJob, self).get_parser(prog_name)
...
class RestartVisualizationJob(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        parser = super(RestartVisJob, self).get_parser(prog_name)
        parser.add_argument(
            'job_id',
            metavar='<job_id>',
            help=_('ID of a visualization job')
...
class ModifyDescriptionVisualizationJobs():
    pass
...
class ShowVisualizationJob(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        parser = super(ShowVisJob, self).get_parser(prog_name)
        parser.add_argument(
            '--job_id',
            metavar='<job_id>',
            help=_('ID of a visualization job')
