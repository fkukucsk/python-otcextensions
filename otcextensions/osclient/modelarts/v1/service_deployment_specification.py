...
class ListServiceDeploymentSpecifications(command.Lister):
    _description = _('This API is used to query service monitoring information. '
    ...
    def get_parser(self, prog_name):
        parser = super(ListServiceDeploymentSpecifications, self).get_parser(prog_name)
        parser.add_argument(
            '--service_id',
            metavar='<service_id>',
            help=_('Service ID')
    ...
    def take_action(self, parsed_args):
        ...
        data = client.service_monitoring_info(**query)
