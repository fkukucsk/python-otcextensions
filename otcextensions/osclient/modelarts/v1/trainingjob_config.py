...
class DeleteTrainingJobConfiguration(command.Command):
    ...
    def get_parser(self, prog_name):
        parser = super(DeleteTrainJobConf, self).get_parser(prog_name)
        parser.add_argument(
            '--config_name',
            metavar='<config_name>',
...
class CreateTrainingJobConfiguration(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        parser = super(CreateTrainJobConf, self).get_parser(prog_name)
        parser.add_argument(
            '--config_name',
            metavar='<config_name>',
            required=True,
            help=_('Name of a training job configuration. The value is a '
        ...
        parser.add_argument(
            '--config_desc',
            metavar='<config_desc>',
            help=_('Description of a training job configuration. The value '
        ...
        parser.add_argument(
            ...
            required=True,
            help=_('Boot file of a training job, which needs to be stored '
                   'in the code directory, for example, /usr/app/boot.py.')
        )
        parser.add_argument(
            '--model_id',
            metavar='<model_id>',
            help=_('Model ID of a training job. After setting model_id, '
        ...
        parser.add_argument(
            '--parameter',
            metavar='<parameter>',
            help=_('Running parameters of a training job. It is a collection '
        ...
        parser.add_argument(
            ...
            metavar='<spec_id>',
            required=True,
            help=_('ID of the resource specifications selected for a '
                   'training job.')
        )
        parser.add_argument(
            '--data_url',
        ...
        parser.add_argument(
            ...
            help=_('Boot command used to start the container of a custom '
        ...
        parser.add_argument(
            ...
            metavar='<type>',
            required=True,
            help=_('Dataset type. The value can be obs or dataset. OBS and '
        ...
        parser.add_argument(
            ...
            metavar='<data_url>',
            required=True,
            help=_('OBS bucket path. This parameter cannot be used together '
...
class ShowTrainingJobConfiguration(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        parser = super(ShowTrainJobConfs, self).get_parser(prog_name)
        parser.add_argument(
            '--config_name',
            metavar='<config_name>',
            help=_('Name of a training job configuration')
...
class ListTrainingJobConfigurations(command.Lister):
    _description = _('This API is used to query the created training '
    ...
    def get_parser(self, prog_name):
        parser = super(ListTrainingJobConfigurations, self).get_parser(prog_name)
        return parser
