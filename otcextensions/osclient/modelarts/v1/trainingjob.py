...
class DeleteTrainingJob(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        client.delete_trainingjob(job_id=parsed_args.job_id)
...
class CreateTrainingJob(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar='<job_name>',
            required=True,
            help=_('Training job name. The value is a string of 1 to 64 '
        ...
        parser.add_argument(
            '--job-desc',
            metavar='<job_desc>',
            help=_('Description of a training job. The value is a string '
        ...
        parser.add_argument(
            ...
            help=_('Dataset version ID of a training job. This parameter '
        ...
        parser.add_argument(
            '--data-source',
            metavar='<data_source>',
            help=_('Dataset of a training job. This parameter cannot be '
...
class ModifyTrainingJobDescription(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        parser = super(ModifyTrainingJobDescription, self).get_parser(prog_name)
        parser.add_argument(
            'jobId',
            metavar='<jobId>',
            help=_('Enter job id')
