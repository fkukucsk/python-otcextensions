...
class SynchronizeDataset(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.synchronize_dataset(**attrs)
...
class ListDatasetSynchronizationTasks(command.Lister):
    _description = _('This API is used to query the execution status '
    ...
    def get_parser(self, prog_name):
        parser = super(ListDatasetSynchronizationTasks, self).get_parser(prog_name)
        parser.add_argument(
            '--dataset_id',
            metavar='<dataset_id>',
