...
class DeleteLabels(command.Command):
    _description = _('This API is used to delete the samples of '
                     'a dataset in batches.')
...
class DeleteSingleLabel(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            '--label_type',
            metavar='<label_type>',
            help=_('Label type. The value is the same as that of '
                   'the dataset type.')
        )
        parser.add_argument(
            '--delete_source',
...
class UploadSampleFiles(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            '--type',
            metavar='<type>',
            help=_('Label type. The value range is the same as that '
                   'of the dataset type.')
        )
        parser.add_argument(
            '--property',
