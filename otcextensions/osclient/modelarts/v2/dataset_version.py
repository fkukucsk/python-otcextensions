...
class CreateDatasetVersion(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            required=True,
            metavar='<dataset_id>',
            help=_('Format of the exported version file, which is '
                   'case insensitive.')
        )
        parser.add_argument(
            '--version_name',
            metavar='<version_name>',
            help=_('version_name. The value is a string of 1 to 32 '
        ...
        parser.add_argument(
            ...
            help=_('Whether to clear the usage information of dataset '
                   'samples. The default value is true.')
        )
        parser.add_argument(
            '--export_images',
            metavar='<export_images>',
            help=_('Whether to export images to the version output directory '
                   'during publishing. The default value is false.')
        )
        parser.add_argument(
            '--train_evaluate_sample_ratio',
            metavar='<train_evaluate_sample_ratio>',
            help=_('Ratio that splits the labeled data into training and '
        ...
        parser.add_argument(
            ...
            help=_('Whether to clear hard example properties. '
