...
class DeleteSampleBatches(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        client.delete_sample_batches(parsed_args.samples,
...
class UploadSampleBatches(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            '--encoding',
            metavar='<encoding>',
            help=_('Encoding type of each file, which is used to upload '
...
class UploadSampleFiles(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            '--encoding',
            metavar='<labels>',
            help=_('Encoding type of each file, which is used to upload text '
