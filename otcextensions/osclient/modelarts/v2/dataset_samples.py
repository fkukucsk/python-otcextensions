...
_formatters = {
    'labels': modelarts_utils.YamlFormat,
    'sample_time': modelarts_utils.UnixTimestampFormatter,
    'source': modelarts_utils.WrapText,
    'metadata': modelarts_utils.YamlFormat,
...
class AddSamples(command.ShowOne):
    _description = _('This API is used to upload sample files such as '
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            'name',
            metavar='name',
            help=_('Name of sample files. The value contains 0 to 1,024 '
        ...
        parser.add_argument(
            '--encoding',
            metavar='<encoding>',
            help=_('Encoding type of sample files, which is used to upload '
...
class ListSamples(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            '--label-type',
            metavar='<label_type>',
            help=_('Labeling type. The options are as follows:'
        ...
        parser.add_argument(
            '--locale',
            metavar='<locale>',
            help=_('Language. The options are as follows:'
        ...
        parser.add_argument(
            '--order',
            metavar='<order>',
            help=_('Sorting sequence of the query. '
        ...
        parser.add_argument(
            ...
            metavar='<preview>',
            type=bool,
            help=_('Whether to support preview. The options are as follows:'
        ...
        parser.add_argument(
            ...
            help=_('Image resizing setting, which is the same as the '
        ...
        parser.add_argument(
            ...
            help=_('Multi-dimensional search condition after URL encoding. '
    ...
    def take_action(self, parsed_args):
        ...
        formatters = {
            'Sample Time': modelarts_utils.UnixTimestampFormatter
        }
...
class ShowSample(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        client = self.app.client_manager.modelarts
        obj = client.get_dataset_sample(parsed_args.datasetId,
                                        parsed_args.sampleId)
...
class DeleteSamples(command.Command):
    _description = _('This API is used to delete the samples of a '
                     'dataset in batches.')
    ...
    def take_action(self, parsed_args):
        ...
        client.delete_dataset_samples(parsed_args.datasetId,
                                      parsed_args.sampleId, delete_source)
