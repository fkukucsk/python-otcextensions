...
class CreateDatasetExportTask(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar='<path>',
            required=True,
            help=_('Dataset name. The value is a string of 1 to 100 '
        ...
        parser.add_argument(
            ...
            help=_('Quantity of the partitions into which data records in '
        ...
        parser.add_argument(
            ...
            action='append',
            help=_('Source data structure that defines JOSN and CSV formats. '
        ...
        parser.add_argument(
            '--labels',
            metavar='<labels>',
            help=_('Period of time for which data is retained in the '
                   'DIS stream.'
        ...
        parser.add_argument(
            '--description',
            metavar='<description>',
            help=_('Dataset description. The value is a string of 0 to 256 '
        ...
        parser.add_argument(
            ...
            help=_('Whether to synchronize the labels in the input path when '
        ...
        parser.add_argument(
            ...
            help=_('Label format information. This parameter is used only '
                   'when a text classification dataset is created.')
        )
        parser.add_argument(
            '--workspace_id',
            metavar='<workspace_id>',
            help=_('Workspace ID. If no workspace is created, the default '
        ...
        parser.add_argument(
            ...
            metavar='<data_path>',
            # required=True,
            help=_('Path of the data source. The value is a string of '
        ...
        parser.add_argument(
            '--type',
            metavar='<type>',
            help=_('Label type. The value range is the same as that of the '
        ...
        parser.add_argument(
            '--property',
            metavar='<property>',
            help=_('Label attributes. For details, see Table 5. If no '
        ...
        parser.add_argument(
            ...
            help=_('Separator between the text and label. By default, '
        ...
        parser.add_argument(
            ...
            help=_('Separator between labels. By default, the comma (,) is '
        ...
        parser.add_argument(
            '--error_code',
            metavar='<text_label_separator>',
            help=_('Error code of a failed API call. For details, see '
        ...
        parser.add_argument(
            '--error_msg',
            metavar='<error_msg>',
            help=_('Error message of a failed API call. This parameter '
