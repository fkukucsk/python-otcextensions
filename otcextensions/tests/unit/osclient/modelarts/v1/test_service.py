...
from otcextensions.osclient.modelarts.v1 import service
...
class TestListServices(fakes.TestModelarts):

    objects = fakes.FakeService.create_multiple(3)

    column_list_headers = ('service_id',
                           'service_name',
                           'infer_type',
                           'status')
...
class TestCreateService(fakes.TestModelarts):
...
class TestShowService(fakes.TestModelarts):
...
class TestDeleteService(fakes.TestModelarts):
