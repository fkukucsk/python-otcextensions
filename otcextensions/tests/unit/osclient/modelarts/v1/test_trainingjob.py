...
from otcextensions.osclient.modelarts.v1 import trainingjob
...
class TestCreateTrainingJob(fakes.TestModelarts):
    ...
    def setUp(self):
        ...
        self.client.create_trainingjob = \
            mock.Mock(return_value=self._trainingjob)
